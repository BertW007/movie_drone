...
urlpatterns = [
    ...
    url(r'^user/footage/delete/(?P<pk>(\d)+)/$', views.FootageDeleteView.as_view(), name='footage-delete'),
    url(r'^user/footage/(?P<pk>(\d)+)', views.FootageUpdateView.as_view(), name="footage-update"),
